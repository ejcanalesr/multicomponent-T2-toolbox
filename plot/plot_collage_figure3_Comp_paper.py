...
plt.savefig(path_to_save_figure + 'Figure3_collage_new.png', bbox_inches='tight', dpi=600)
plt.close()
...
plt.savefig(path_to_save_figure + 'Figure3_colorbars.png', bbox_inches='tight', dpi=600)
